...
set_property PACKAGE_PIN V13 [get_ports {status[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {status[0]}]
set_property PACKAGE_PIN V3 [get_ports {status[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {status[1]}]
set_property PACKAGE_PIN W3 [get_ports {status[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {status[2]}]
set_property PACKAGE_PIN U3 [get_ports {status[3]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {status[3]}]
set_property PACKAGE_PIN P3 [get_ports {status[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {status[4]}]
set_property PACKAGE_PIN N3 [get_ports {status[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {status[5]}]
set_property PACKAGE_PIN P1 [get_ports {status[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {status[6]}]
set_property PACKAGE_PIN L1 [get_ports {status[7]}]					
...
#set_property PACKAGE_PIN T18 [get_ports button_top]
#	set_property IOSTANDARD LVCMOS33 [get_ports button_top]
...
#set_property PACKAGE_PIN U17 [get_ports button_bottom]
#	set_property IOSTANDARD LVCMOS33 [get_ports button_bottom]
...
##USB-RS232 Interface
set_property PACKAGE_PIN B18 [get_ports uart_receive]						
	set_property IOSTANDARD LVCMOS33 [get_ports uart_receive]
set_property PACKAGE_PIN A18 [get_ports uart_transmit]						
	set_property IOSTANDARD LVCMOS33 [get_ports uart_transmit]
