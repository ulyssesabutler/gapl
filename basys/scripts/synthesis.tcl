...
set veri_files [concat \
    [glob -directory $dir_rtl_veri -types f *.v] \
    ...
    [glob -directory "$dir_rtl_veri/string_matching" -types f *.v] \
    [glob -directory "$gen_dir" -types f *.v] \
]
...
read_xdc ${dir_constraint}/basys-3.xdc

# set constraint files for synthesis and implementation
set_property used_in_synthesis true [get_files $dir_constraint/basys-3.xdc]
set_property used_in_implementation true [get_files $dir_constraint/basys-3.xdc]
