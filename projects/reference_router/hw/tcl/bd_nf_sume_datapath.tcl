...
proc create_hier_cell_nf_sume_datapath { parentCell coreName tdataWidth} {
   ...
   connect_bd_net [get_bd_pins axis_aclk] [get_bd_pins router_output_port_lookup_0/axis_aclk]
   ...
   connect_bd_net [get_bd_pins axis_resetn] [get_bd_pins router_output_port_lookup_0/axis_resetn]
   ...
   connect_bd_net [get_bd_pins s_axi_aclk] [get_bd_pins router_output_port_lookup_0/S_AXI_ACLK] 
   ...
   connect_bd_net [get_bd_pins s_axi_aresetn] [get_bd_pins router_output_port_lookup_0/S_AXI_ARESETN]
   ...
   connect_bd_intf_net [get_bd_intf_pins s_axi_lite_1] [get_bd_intf_pins router_output_port_lookup_0/S_AXI] 
   ...
   connect_bd_intf_net [get_bd_intf_pins endianess_manager_0/M_AXIS_INT] [get_bd_intf_pins router_output_port_lookup_0/s_axis]
   connect_bd_intf_net [get_bd_intf_pins router_output_port_lookup_0/m_axis] [get_bd_intf_pins endianess_manager_0/S_AXIS_INT]
