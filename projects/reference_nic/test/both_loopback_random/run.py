...
if isHW():
    ...
    nftest_regread_expect(SUME_INPUT_ARBITER_0_PKTIN(), 0x400)
    nftest_regread_expect(SUME_INPUT_ARBITER_0_PKTOUT(), 0x400)
    nftest_regread_expect(SUME_OUTPUT_QUEUES_0_PKTSTOREDPORT4(), 0x400)
    nftest_regread_expect(SUME_OUTPUT_QUEUES_0_PKTREMOVEDPORT4(), 0x400) 
    nftest_regread_expect(SUME_OUTPUT_PORT_LOOKUP_0_PKTIN(), 0x400) 
    nftest_regread_expect(SUME_OUTPUT_PORT_LOOKUP_0_PKTOUT(), 0x400) 
    mres=[]
