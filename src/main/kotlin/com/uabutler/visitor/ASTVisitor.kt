...
class ASTVisitor: GAPLBaseVisitor<GAPLNode>() {
    ...
    private fun visitInterfaceExpression(ctx: GAPLParser.InterfaceExpressionContext): InterfaceExpressionNode {
        return when (ctx) {
    ...
    private fun visitStaticExpression(ctx: GAPLParser.StaticExpressionContext): StaticExpressionNode {
        return when (ctx) {
            ...
            is GAPLParser.SubtractStaticExpressionContext -> SubtractNode(visitStaticExpression(ctx.lhs!!), visitStaticExpression(ctx.rhs!!))
            is GAPLParser.MultiplyStaticExpressionContext -> MultiplyNode(visitStaticExpression(ctx.lhs!!), visitStaticExpression(ctx.rhs!!))
            is GAPLParser.DivideStaticExpressionContext -> DivideNode(visitStaticExpression(ctx.lhs!!), visitStaticExpression(ctx.rhs!!))
            is GAPLParser.EqualsStaticExpressionContext -> EqualsNode(visitStaticExpression(ctx.lhs!!), visitStaticExpression(ctx.rhs!!))
            is GAPLParser.NotEqualsStaticExpressionContext -> NotEqualsNode(visitStaticExpression(ctx.lhs!!), visitStaticExpression(ctx.rhs!!))
            is GAPLParser.LessThanStaticExpressionContext -> LessThanNode(visitStaticExpression(ctx.lhs!!), visitStaticExpression(ctx.rhs!!))
            is GAPLParser.GreaterThanStaticExpressionContext -> GreaterThanNode(visitStaticExpression(ctx.lhs!!), visitStaticExpression(ctx.rhs!!))
            is GAPLParser.LessThanEqualsStaticExpressionContext -> LessThanEqualsNode(visitStaticExpression(ctx.lhs!!), visitStaticExpression(ctx.rhs!!))
            is GAPLParser.GreaterThanEqualsStaticExpressionContext -> GreaterThanEqualsNode(visitStaticExpression(ctx.lhs!!), visitStaticExpression(ctx.rhs!!))
