...
import com.uabutler.v2.gaplir.Module
...
class ModuleInstantiationTracker(
    ...
    fun visitModule(instantiationData: ModuleInstantiationData): ModuleInstantiation {
        ...
        val interfaceValues = GenericValueMatcher.getInterfaceValues(astNode.genericInterfaces, instantiationData.genericInterfaceValues)
        val parameterValues = GenericValueMatcher.getParameterValues(astNode.genericParameters, instantiationData.genericParameterValues)
