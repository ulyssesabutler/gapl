...
import com.uabutler.v1.ast.interfaces.DefinedInterfaceExpressionNode
import com.uabutler.v1.ast.interfaces.InterfaceExpressionNode
import com.uabutler.v1.references.FunctionDeclaration
import com.uabutler.v1.references.InterfaceDeclaration
    ...
    companion object {
        ...
        fun fromInstantiationNode(
            ...
            if (PredefinedFunction.isNativeFunction(expressionNode.interfaceIdentifier.value)) {
                return PredefinedFunction.moduleNodeFromPredefinedFunction(
                    identifier,
                    expressionNode.interfaceIdentifier.value
                )
            }
