...
import com.uabutler.v1.ast.functions.circuits.*
import com.uabutler.v1.util.AnonymousIdentifiers
    ...
    private fun processCircuitNodeExpressionNode(circuitNodeExpressionNode: CircuitNodeExpressionNode): ModuleNode {
        when (circuitNodeExpressionNode) {
            ...
            is AnonymousNodeCircuitExpressionNode -> {
                return createAnonymousNode {
                    ModuleNode.fromInterfaceExpressionNode(
                        it,
                        circuitNodeExpressionNode.type,
