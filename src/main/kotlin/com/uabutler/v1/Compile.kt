package com.uabutler.v1

import com.uabutler.v1.ast.ProgramNode
import com.uabutler.v1.module.ModuleBuilder
import com.uabutler.v1.verilog.VerilogWriter
...
fun test() {
    ...
    val parser = Parser.fromString(programAddAnon)
    val ast = ProgramNode.fromParser(parser)
