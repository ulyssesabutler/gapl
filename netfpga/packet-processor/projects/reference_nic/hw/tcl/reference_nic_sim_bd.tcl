...
#####################################
source $::env(NF_DESIGN_DIR)/hw/tcl/reference_nic_defines.tcl

create_project -name ${design} -force -dir "$::env(NF_DESIGN_DIR)/hw/${proj_dir}" -part ${device}

file copy -force ${public_repo_dir}/ ${repo_dir}/
...
source $::env(NF_DESIGN_DIR)/hw/tcl/reference_nic_bd_port_sim.tcl
source $::env(NF_DESIGN_DIR)/hw/tcl/reference_nic_bd_connection_sim.tcl
