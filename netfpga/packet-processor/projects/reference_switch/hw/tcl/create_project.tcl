...
read_verilog "./hdl/util/axis/axis_mask_back.v"
read_verilog "./hdl/util/axis/axis_queue.v"
read_verilog "./hdl/util/axis/axis_pad_output.v"
...
# packet_processor/
read_verilog "./hdl/packet_processor/packet_parser.v"
