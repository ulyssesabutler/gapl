...
#Add a clock wizard
# GAPL: clk_wiz_ip's multiply/divide/jitter/phase-error configuration is generated by
# solve_clk_wiz.tcl (from clockPeriodNs, via Vivado's own Clocking Wizard solver) rather than
# hand-written here - a hand-edited dict here previously went out of sync with the create_clock
# constraint installed into the .xdc, since nothing kept the two in agreement. See the netfpga
# clock-period workflow investigation for the incident this replaced.
