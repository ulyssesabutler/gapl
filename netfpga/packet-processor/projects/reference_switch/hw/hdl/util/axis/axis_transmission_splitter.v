...
(
  ...
  input  wire  [((IN_TDATA_WIDTH / 8)) - 1:0]  axis_original_tkeep,
  ...
  output wire [OUT_TDATA_WIDTH - 1:0]         axis_resize_0_tdata,
  output wire [((OUT_TDATA_WIDTH / 8)) - 1:0] axis_resize_0_tkeep,
  output wire [TUSER_WIDTH - 1:0]             axis_resize_0_tuser,
  output wire                                 axis_resize_0_tvalid,
  input  wire                                 axis_resize_0_tready,
  output wire                                 axis_resize_0_tlast,

  output wire [OUT_TDATA_WIDTH - 1:0]         axis_resize_1_tdata,
  output wire [((OUT_TDATA_WIDTH / 8)) - 1:0] axis_resize_1_tkeep,
  output wire [TUSER_WIDTH - 1:0]             axis_resize_1_tuser,
  output wire                                 axis_resize_1_tvalid,
  input  wire                                 axis_resize_1_tready,
  output wire                                 axis_resize_1_tlast,

  output wire [OUT_TDATA_WIDTH - 1:0]         axis_resize_2_tdata,
  output wire [((OUT_TDATA_WIDTH / 8)) - 1:0] axis_resize_2_tkeep,
  output wire [TUSER_WIDTH - 1:0]             axis_resize_2_tuser,
  output wire                                 axis_resize_2_tvalid,
  input  wire                                 axis_resize_2_tready,
  output wire                                 axis_resize_2_tlast,

  output wire [OUT_TDATA_WIDTH - 1:0]         axis_resize_3_tdata,
  output wire [((OUT_TDATA_WIDTH / 8)) - 1:0] axis_resize_3_tkeep,
  output wire [TUSER_WIDTH - 1:0]             axis_resize_3_tuser,
  output wire                                 axis_resize_3_tvalid,
  input  wire                                 axis_resize_3_tready,
  output wire                                 axis_resize_3_tlast
);
