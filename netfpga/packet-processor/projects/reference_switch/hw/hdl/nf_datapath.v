...
#(
    ...
    //Output Port Lookup
    output_port_lookup_ip output_port_lookup_1
    (
        .axis_aclk(axis_aclk),
        .axis_resetn(axis_resetn),
    ...
    (
        ...
        .packet_in_axis_tdata  (m_axis_opl_tdata),
        .packet_in_axis_tkeep  (m_axis_opl_tkeep),
        .packet_in_axis_tuser  (m_axis_opl_tuser),
        .packet_in_axis_tvalid (m_axis_opl_tvalid),
        .packet_in_axis_tready (m_axis_opl_tready),
        .packet_in_axis_tlast  (m_axis_opl_tlast),
