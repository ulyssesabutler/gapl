...
## -- 200MHz & 100MHz clks
create_clock -period 10000.000 -name clk_200 -add [get_pins -hier -filter name=~*axi_clocking_i*clk_wiz_i/clk_out1]
create_clock -period 10000.000 -name axi_clk -add [get_pins -hier -filter name=~*axi_lite_bufg0/O]
