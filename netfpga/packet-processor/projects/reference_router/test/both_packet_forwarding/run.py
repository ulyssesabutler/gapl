...
if isHW():
	rres1=nftest_regread_expect(SUME_OUTPUT_PORT_LOOKUP_0_PKT_FORWARDED_CNTR(), pkts_num*2);
	mres=[rres1]
else:
	nftest_regread_expect(SUME_OUTPUT_PORT_LOOKUP_0_PKT_FORWARDED_CNTR(), pkts_num);
	mres=[]
