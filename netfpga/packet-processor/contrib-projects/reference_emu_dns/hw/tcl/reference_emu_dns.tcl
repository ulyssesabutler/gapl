...
create_ip -name emudns_output_port_lookup -vendor NetFPGA -library NetFPGA -module_name emudns_output_port_lookup_ip
set_property generate_synth_checkpoint false [get_files emudns_output_port_lookup_ip.xci]
reset_target all [get_ips emudns_output_port_lookup_ip]
generate_target all [get_ips emudns_output_port_lookup_ip]

#create_ip -name db -vendor NetFPGA -library NetFPGA -module_name memcached
#set_property generate_synth_checkpoint false [get_files memcached.xci]
#reset_target all [get_ips memcached]
#generate_target all [get_ips memcached]
...
create_ip -name div -vendor NetFPGA -library NetFPGA -module_name div_ip
set_property generate_synth_checkpoint false [get_files div_ip.xci]
reset_target all [get_ips div_ip]
generate_target all [get_ips div_ip]
