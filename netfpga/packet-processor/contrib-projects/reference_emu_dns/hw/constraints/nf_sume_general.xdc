...
## QDR(B) SRAM Clock
#set_property VCCAUX_IO DONTCARE [get_ports {qdrb_clk_p}]
#set_property IOSTANDARD DIFF_SSTL15 [get_ports {qdrb_clk_p}]
#set_property PACKAGE_PIN AU14 [get_ports {qdrb_clk_p}]
#
#set_property VCCAUX_IO DONTCARE [get_ports {qdrb_clk_n}]
#set_property IOSTANDARD DIFF_SSTL15 [get_ports {qdrb_clk_n}]
#set_property PACKAGE_PIN AU13 [get_ports {qdrb_clk_n}]
#
#create_clock -period 5.000 [get_nets qdrb_clk_p]
#
## QDR(A) SRAM Clock
...
#
#set_property VCCAUX_IO DONTCARE [get_ports {qdra_clk_n}]
#set_property IOSTANDARD DIFF_SSTL15 [get_ports {qdra_clk_n}]
#set_property PACKAGE_PIN AD33 [get_ports {qdra_clk_n}]
#
#create_clock -period 5.000 [get_nets qdra_clk_p]

# DDR3 DRAM Clock
#set_property VCCAUX_IO DONTCARE [get_ports {dram_clk_p}]
#set_property IOSTANDARD DIFF_SSTL15 [get_ports {dram_clk_p}]
#set_property PACKAGE_PIN E34 [get_ports {dram_clk_p}]
#
#set_property VCCAUX_IO DONTCARE [get_ports {dram_clk_n}]
#set_property IOSTANDARD DIFF_SSTL15 [get_ports {dram_clk_n}]
#set_property PACKAGE_PIN E35 [get_ports {dram_clk_n}]
#
#create_clock -period 4.288 [get_nets dram_clk_p]

## -- 200MHz & 100MHz clks
create_clock -period 6.250  -name clk_200 -add [get_pins -hier -filter name=~*axi_clocking_i*clk_wiz_i/clk_out1]
...
# Yuta added 20171116
#set_false_path -from [get_clocks clk_pll_i] -to [get_clocks clk_200]
#set_false_path -from [get_clocks clk_200] -to [get_clocks clk_pll_i]
## for MIG reset 
#set_false_path -from [get_clocks clk_200] -to [get_clocks mmcm_ps_clk_bufg_in]


### Error 20171115
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets sys_clk]
#set_property CLOCK_DEDICATED_ROUTE BACKBONE [get_nets axi_clocking_i/clkin1]

#### Error 20171120
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets nf_datapath_0/u_db/inst/u_sram_cont/u_sume_mig_sram/u_sume_mig_sram_mig/c0_u_clk_ibuf/sys_clk_ibufg]
#set_property CLOCK_DEDICATED_ROUTE BACKBONE [get_nets nf_datapath_0/u_db/inst/u_sram_cont/u_sume_mig_sram/u_sume_mig_sram_mig/c0_u_infrastructure/clk_pll_i]
#set_property CLOCK_DEDICATED_ROUTE BACKBONE [get_nets nf_datapath_0/u_db/inst/u_sram_cont/u_sume_mig_sram/u_sume_mig_sram_mig/c0_u_infrastructure/mmcm_ps_clk_bufg_in]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets nf_datapath_0/u_db/inst/u_sram_cont/u_sume_mig_sram/u_sume_mig_sram_mig/c0_u_infrastructure/clk_pll_i]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets nf_datapath_0/u_db/inst/u_sram_cont/u_sume_mig_sram/u_sume_mig_sram_mig/c0_u_infrastructure/mmcm_ps_clk_bufg_in]
#
## Yuta added 20171120
#set_false_path -from [get_clocks clk_pll_i_1] -to [get_clocks clk_200]
#set_false_path -from [get_clocks clk_200] -to [get_clocks clk_pll_i_1]
#
#set_false_path -from [get_clocks mmcm_ps_clk_bufg_in_1] -to [get_clocks clk_pll_i_1]
#set_false_path -from [get_clocks clk_pll_i_1] -to [get_clocks mmcm_ps_clk_bufg_in_1]
# Yuta added 20171123
#set_false_path -from [get_clocks clk_ref_mmcm_400] -to [get_clocks clk_ref_mmcm_400]

# Yuta added 20171130
#set_false_path -from [get_clocks clk_pll_i_2] -to [get_clocks clk_200]
#set_false_path -from [get_clocks clk_200] -to [get_clocks clk_pll_i_2]

#Yuta added 20171203
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets nf_10g_interface_0/inst/nf_10g_interface_shared_i/axi_10g_ethernet_i/inst/xpcs/inst/ten_gig_eth_pcs_pma_shared_clock_reset_block/refclk]

# Yuta added 20180322
#set_input_delay -clock dram_clk_p 0 *ddr3_dqs_*
