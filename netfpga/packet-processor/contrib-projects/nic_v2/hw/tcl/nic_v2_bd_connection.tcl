...
connect_bd_net [get_bd_ports reset] [get_bd_pins proc_sys_reset_2/ext_reset_in]
...
connect_bd_net [get_bd_pins sys_clock_0/locked] [get_bd_pins proc_sys_reset_1/dcm_locked]
connect_bd_net [get_bd_pins sys_clock_0/locked] [get_bd_pins proc_sys_reset_2/dcm_locked]
...
connect_bd_net [get_bd_pins nf_sume_dma/pcie_user_clk] [get_bd_pins proc_sys_reset_2/slowest_sync_clk]

# 160Mhz clock scheme - data stream
connect_bd_net [get_bd_pins sys_clock_0/clk_out2] [get_bd_pins proc_sys_reset_1/slowest_sync_clk]
...
connect_bd_net [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins nf_sume_dma/axis_aresetn]
...
connect_bd_net [get_bd_pins proc_sys_reset_2/peripheral_aresetn] [get_bd_pins axi_interconnect_0/M10_ARESETN]
connect_bd_net [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins axi_interconnect_0/M11_ARESETN]

connect_bd_net [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins nf_10g_interface_0/core_resetn]
connect_bd_net [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins nf_10g_interface_1/core_resetn]
connect_bd_net [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins nf_10g_interface_2/core_resetn]
connect_bd_net [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins nf_10g_interface_3/core_resetn]

connect_bd_net [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins input_arbiter_0/axis_resetn]
connect_bd_net [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins nic_output_port_lookup_0/axis_resetn]
connect_bd_net [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins output_queues_0/axis_resetn]
...
connect_bd_net [get_bd_pins proc_sys_reset_1/mb_debug_sys_rst] [get_bd_pins mbsys/Debug_SYS_Rst]
connect_bd_net [get_bd_pins proc_sys_reset_2/mb_debug_sys_rst] [get_bd_pins mbsys/Debug_SYS_Rst]
