#
# Copyright (c) 2017 Pietro Bressana, Universita' della Svizzera italiana, Lugano (Switzerland)
# All rights reserved.
#
...
set design nf_sume_pktgen
set top nf_sume_pktgen
...
puts "Creating nf_sume_pktgen IP"
# Project Constraints
#####################################
# Project Structure & IP Build
#####################################
read_verilog "./hdl/nf_sume_pktgen_cpu_regs_defines.v"
read_verilog "./hdl/nf_sume_pktgen_cpu_regs.v"
read_verilog "./hdl/nf_sume_pktgen.v"
...
set_property value {136} [ipx::get_user_parameter C_M_AXIS_TUSER_WIDTH [ipx::current_core]]
...
# set_property value {1} [ipx::get_user_parameter NUM_QUEUES [ipx::current_core]]
...
ipx::associate_bus_interfaces -busif m_axis_0 -clock axis_aclk [ipx::current_core]
