...
set DEF_LIST {
	...
	{EMU_OUTPUT_PORT_LOOKUP 0 1 emudns_output_port_lookup_v1_0_0/data/output_port_lookup_regs_defines.txt} \
	{DIV 0 1 div_v1_0_0/data/div_regs_defines.txt} \
	{ARBITER1 1 1 input_arbiter_v1_0_0/data/input_arbiter_regs_defines.txt} \
}
...
if $has_registers {
	if {$lib_name == "emudns_output_port_lookup_v1_0_0/data/output_port_lookup_regs_defines.txt" ||
		$lib_name == "div_v1_0_0/data/div_regs_defines.txt"} {
