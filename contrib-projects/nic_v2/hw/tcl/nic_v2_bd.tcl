...
source tcl/bd_nf_sume_uam_dma_engine.tcl
create_hier_cell_nf_sume_naudit_dma_engine [current_bd_instance . ] nf_sume_dma
...
source ./tcl/nic_v2_bd_port.tcl
source ./tcl/nic_v2_bd_connection.tcl
...
create_bd_addr_seg -range ${MICROBLAZE_AXI_IIC_SIZEADDR} -offset ${MICROBLAZE_AXI_IIC_BASEADDR} [get_bd_addr_spaces nf_sume_dma/nf_naudit_dma_0/m_axi_lite] \
   [get_bd_addr_segs axi_iic_0/S_AXI/Reg] SEG_axi_iic_0_Reg
create_bd_addr_seg -range ${MICROBLAZE_UARTLITE_SIZEADDR} -offset ${MICROBLAZE_UARTLITE_BASEADDR} [get_bd_addr_spaces nf_sume_dma/nf_naudit_dma_0/m_axi_lite] \
   [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] SEG_axi_uartlite_0_Reg
...
create_bd_addr_seg -range ${INPUT_ARBITER_SIZEADDR} -offset ${INPUT_ARBITER_BASEADDR} [get_bd_addr_spaces nf_sume_dma/nf_naudit_dma_0/m_axi_lite] \
   [get_bd_addr_segs input_arbiter_0/S_AXI/reg0] SEG_input_arbiter_0_reg0
...
create_bd_addr_seg -range ${OUTPUT_PORT_LOOKUP_SIZEADDR} -offset ${OUTPUT_PORT_LOOKUP_BASEADDR} [get_bd_addr_spaces nf_sume_dma/nf_naudit_dma_0/m_axi_lite] \
   [get_bd_addr_segs nic_output_port_lookup_0/S_AXI/reg0] SEG_nic_output_port_lookup_0_reg0
...
create_bd_addr_seg -range ${OUTPUT_QUEUES_SIZEADDR} -offset ${OUTPUT_QUEUES_BASEADDR} [get_bd_addr_spaces nf_sume_dma/nf_naudit_dma_0/m_axi_lite] \
   [get_bd_addr_segs output_queues_0/S_AXI/reg0] SEG_output_queues_0_reg0
...
create_bd_addr_seg -range ${NF_10G_INTERFACE0_SIZEADDR} -offset ${NF_10G_INTERFACE0_BASEADDR} [get_bd_addr_spaces nf_sume_dma/nf_naudit_dma_0/m_axi_lite] \
   [get_bd_addr_segs nf_10g_interface_0/S_AXI/reg0] SEG_nf_10g_interface_0_reg0
...
create_bd_addr_seg -range ${NF_10G_INTERFACE1_SIZEADDR} -offset ${NF_10G_INTERFACE1_BASEADDR} [get_bd_addr_spaces nf_sume_dma/nf_naudit_dma_0/m_axi_lite] \
   [get_bd_addr_segs nf_10g_interface_1/S_AXI/reg0] SEG_nf_10g_interface_1_reg0
...
create_bd_addr_seg -range ${NF_10G_INTERFACE2_SIZEADDR} -offset ${NF_10G_INTERFACE2_BASEADDR} [get_bd_addr_spaces nf_sume_dma/nf_naudit_dma_0/m_axi_lite] \
   [get_bd_addr_segs nf_10g_interface_2/S_AXI/reg0] SEG_nf_10g_interface_2_reg0
...
create_bd_addr_seg -range ${NF_10G_INTERFACE3_SIZEADDR} -offset ${NF_10G_INTERFACE3_BASEADDR} [get_bd_addr_spaces nf_sume_dma/nf_naudit_dma_0/m_axi_lite] \
   [get_bd_addr_segs nf_10g_interface_3/S_AXI/reg0] SEG_nf_10g_interface_3_reg0

create_bd_addr_seg -range ${NF_RIFFA_DMA_SIZEADDR} -offset ${NF_RIFFA_DMA_BASEADDR} [get_bd_addr_spaces mbsys/microblaze_0/Data] \
   [get_bd_addr_segs nf_sume_dma/nf_naudit_dma_0/s_axi_lite/reg0] SEG_nf_riffa_dma_0_reg0
create_bd_addr_seg -range ${NF_RIFFA_DMA_SIZEADDR} -offset ${NF_RIFFA_DMA_BASEADDR} [get_bd_addr_spaces nf_sume_dma/nf_naudit_dma_0/m_axi_lite] \
   [get_bd_addr_segs nf_sume_dma/nf_naudit_dma_0/s_axi_lite/reg0] SEG_nf_riffa_dma_0_reg0
...
create_bd_addr_seg -range ${IDENTIFIER_SIZEADDR} -offset ${IDENTIFIER_BASEADDR} [get_bd_addr_spaces nf_sume_dma/nf_naudit_dma_0/m_axi_lite] \
   [get_bd_addr_segs nf_identifier_0/S_AXI/reg0] SEG_nf_identifier_0_reg0
...
create_ip_run [get_files ./${proj_dir}/${design}.srcs/sources_1/ip/user_fifo/user_fifo.xci]
launch_runs user_fifo_synth_1
wait_on_run user_fifo_synth_1

create_ip_run [get_files ./${proj_dir}/${design}.srcs/sources_1/ip/tag_fifo/tag_fifo.xci]
launch_runs tag_fifo_synth_1
wait_on_run tag_fifo_synth_1

create_ip_run [get_files ./${proj_dir}/${design}.srcs/sources_1/ip/stream_fifo/stream_fifo.xci]
launch_runs stream_fifo_synth_1
wait_on_run stream_fifo_synth_1

create_ip_run [get_files ./${proj_dir}/${design}.srcs/sources_1/ip/blk_mem_descriptor/blk_mem_descriptor.xci]
launch_runs blk_mem_descriptor_synth_1
...
set_property strategy Congestion_SpreadLogic_low $obj
