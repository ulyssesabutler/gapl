...
set_false_path -from [get_clocks clk_out1_nic_v2_sys_clock_0_0] -to [get_clocks xgemac_clk_156]
set_false_path -from [get_clocks xgemac_clk_156] -to [get_clocks clk_out1_nic_v2_sys_clock_0_0]

set_false_path -from [get_clocks clk_out2_nic_v2_sys_clock_0_0] -to [get_clocks xgemac_clk_156]
set_false_path -from [get_clocks xgemac_clk_156] -to [get_clocks clk_out2_nic_v2_sys_clock_0_0]

set_false_path -from [get_clocks clk_out1_nic_v2_sys_clock_0_0] -to [get_clocks clk_out2_nic_v2_sys_clock_0_0]
set_false_path -from [get_clocks clk_out2_nic_v2_sys_clock_0_0] -to [get_clocks clk_out1_nic_v2_sys_clock_0_0]
...
set_false_path -from [get_clocks userclk1] -to [get_clocks clk_out1_nic_v2_sys_clock_0_0]
set_false_path -from [get_clocks clk_out1_nic_v2_sys_clock_0_0] -to [get_clocks userclk1]
...
set_false_path -from [get_clocks userclk1] -to [get_clocks clk_out2_nic_v2_sys_clock_0_0]
set_false_path -from [get_clocks clk_out2_nic_v2_sys_clock_0_0] -to [get_clocks userclk1]

set_false_path -from [get_clocks userclk1] -to [get_clocks userclk2]
set_false_path -from [get_clocks userclk2] -to [get_clocks userclk1]
