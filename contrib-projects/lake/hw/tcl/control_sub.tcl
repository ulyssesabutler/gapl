...
proc create_hier_cell_dma_sub { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type clk M09_ACLK
  create_bd_pin -dir I -type rst M09_ARESETN
  create_bd_pin -dir I -type clk M10_ACLK
  create_bd_pin -dir I -type rst M10_ARESETN
  create_bd_pin -dir I -type clk M11_ACLK
  create_bd_pin -dir I -type rst M11_ARESETN
  
  # Create instance: axi_interconnect_0, and set properties
  set axi_interconnect_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_interconnect_0 ]
  set_property -dict [ list CONFIG.NUM_MI {12}  ] $axi_interconnect_0
  ...
  set_property -dict [list CONFIG.M09_HAS_REGSLICE {3} CONFIG.M09_HAS_DATA_FIFO {1} ] $axi_interconnect_0
  set_property -dict [list CONFIG.M10_HAS_REGSLICE {3} CONFIG.M10_HAS_DATA_FIFO {1} ] $axi_interconnect_0
  set_property -dict [list CONFIG.M11_HAS_REGSLICE {3} CONFIG.M11_HAS_DATA_FIFO {1} ] $axi_interconnect_0
...
connect_bd_net -net M09_ACLK_i [get_bd_pins M09_ACLK] [get_bd_pins axi_interconnect_0/M09_ACLK] 
connect_bd_net -net M10_ACLK_i [get_bd_pins M10_ACLK] [get_bd_pins axi_interconnect_0/M10_ACLK] 
connect_bd_net -net M11_ACLK_i [get_bd_pins M11_ACLK] [get_bd_pins axi_interconnect_0/M11_ACLK] 
...
connect_bd_net -net M09_ARESETN_i [get_bd_pins M09_ARESETN]  [get_bd_pins axi_interconnect_0/M09_ARESETN]
connect_bd_net -net M10_ARESETN_i [get_bd_pins M10_ARESETN]  [get_bd_pins axi_interconnect_0/M10_ARESETN]
connect_bd_net -net M11_ARESETN_i [get_bd_pins M11_ARESETN]  [get_bd_pins axi_interconnect_0/M11_ARESETN]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.ADDR_WIDTH {12} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $M09_AXI
  set M10_AXI [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M10_AXI ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {12} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $M10_AXI
  set M11_AXI [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M11_AXI ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {12} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $M11_AXI
  ...
  connect_bd_intf_net -intf_net dma_sub_M09_AXI [get_bd_intf_ports M09_AXI] [get_bd_intf_pins dma_sub/M09_AXI]
  connect_bd_intf_net -intf_net dma_sub_M10_AXI [get_bd_intf_ports M10_AXI] [get_bd_intf_pins dma_sub/M10_AXI]
  connect_bd_intf_net -intf_net dma_sub_M11_AXI [get_bd_intf_ports M11_AXI] [get_bd_intf_pins dma_sub/M11_AXI]
  ...
  create_bd_addr_seg -range $M09_SIZEADDR -offset $M09_BASEADDR [get_bd_addr_spaces dma_sub/nf_riffa_dma_1/m_axi_lite] [get_bd_addr_segs M09_AXI/Reg] SEG_M09_AXI_Reg
  create_bd_addr_seg -range $M10_SIZEADDR -offset $M10_BASEADDR [get_bd_addr_spaces dma_sub/nf_riffa_dma_1/m_axi_lite] [get_bd_addr_segs M10_AXI/Reg] SEG_M10_AXI_Reg
  create_bd_addr_seg -range $M11_SIZEADDR -offset $M11_BASEADDR [get_bd_addr_spaces dma_sub/nf_riffa_dma_1/m_axi_lite] [get_bd_addr_segs M11_AXI/Reg] SEG_M11_AXI_Reg
